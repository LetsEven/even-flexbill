          ...
          <div className="flex items-center space-x-1">
            {remainingCount > 0 && (
              <div
                ...
                className="size-10 md:size-12 lg:size-14 bg-white rounded-full flex items-center justify-center text-black text-base font-medium border border-stroke shadow-sm cursor-pointer"
              >
                +{remainingCount}
              </div>
            )}

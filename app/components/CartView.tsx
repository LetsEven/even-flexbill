              ...
              >
                <div className="w-full flex gap-3 md:gap-4 lg:gap-5 mt-6 md:mt-7 lg:mt-8 justify-between">
                  ...
                  <button
                    ...
                    className={`py-3 md:py-4 lg:py-5 bg-even-grass text-even-evergreen rounded-full cursor-pointer font-normal h-fit flex items-center justify-center text-base md:text-lg lg:text-xl active:scale-95 transition-transform ${
                      isSubmitting || cartState.isLoading
                        ? "opacity-50 cursor-not-allowed px-10 md:px-12 lg:px-14"
                        : "px-18 md:px-20 lg:px-24 animate-pulse-button"
                    }`}
                  >
                    {isSubmitting || cartState.isLoading
                      ? "Cargando..."
